...
"Collection24": { pin: "7359", moradores: [{ nome: "FERNANDA MIRANDA CARRILLO", tel: "11970951050" }, { nome: "ROSINES MIRANDA CARRILLO", tel: "11988814161" }] },
"Collection31": { pin: "8421", moradores: [{ nome: "BELMIRO DIAS", tel: "11982594151" }, { nome: "CAROLINA ROSA DIAS", tel: "11982594151" }, { nome: "FLAVIA HOLDEREGGER", tel: "11982594148" }, { nome: "RICARDO HOLDEREGGER", tel: "11982594151" }] },
...
"Collection41": { pin: "3894", moradores: [{ nome: "ERIKA KOGA", tel: "11991693807" }, { nome: "MARINA KOGA", tel: "11984455517" }, { nome: "MAURO NOBORU KOGA", tel: "11991693807" }] },
...
"Collection51": { pin: "7492", moradores: [{ nome: "RENATO QUIDIQUIMO", tel: "11948558000" }] },
"Collection52": { pin: "3572", moradores: [{ nome: "TATIANE SACHET", tel: "11982230034" }, { nome: "THIAGO SACHET", tel: "11942229753" }] },
...
"Collection64": { pin: "4386", moradores: [{ nome: "KLEBER ROGERIO VALADAR", tel: "11989927680" }, { nome: "CRISMILENE", tel: "11989927680" }] },
...
"Collection74": { pin: "8725", moradores: [{ nome: "FABIO ALVES DE SOUZA", tel: "11947643431" }, { nome: "MONICA SANTOS", tel: "11910523480" }] },
...
"Collection94": { pin: "7504", moradores: [{ nome: "CLEBER LUIZ CAETANO DE JESUS", tel: "11981078812" }, { nome: "PATRICIA CARPI", tel: "11981078812" }] },
...
"Collection163": { pin: "7271", moradores: [{ nome: "JOELCIO FIORIN", tel: "11970147401" }, { nome: "CAROLINE BRITO", tel: "7191945678" }, { nome: "PEDRO VINICIUS GOMES", tel: "71986098172" }] },
"Collection164": { pin: "8382", moradores: [{ nome: "DANIELLE BATISTA", tel: "11983401494" }] },
    ...
    let conteudo = `
        ...
        <head>
            ...
            <style>
                ...
                .apto-destaque { font-weight: bold; font-size: 14px; color: #DAA520; }
        ...
        <body>
            ...
            <p><strong>Data:</strong> ${dataBusca} | <strong>Total:</strong> ${entregas.length}</p>
            <div class="grid">
    `;
...
function limparPorData() {
    ...
    const confirmacao = confirm(`⚠️ CUIDADO: Você vai apagar permanentemente ${totalNaData} registros de ${dataFormatada}.\n\nVOCÊ JÁ SALVOU O RELATÓRIO EM PDF?\n\nClique em OK apenas se já tiver o comprovante salvo.`);

    if (confirmacao) {
        // Remove as encomendas daquela data
